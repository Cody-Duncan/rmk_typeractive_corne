# RMK Config for Typeractive Corne
`rmk_typeractive_corne`

RMK firmware configuration for the Typeractive Corne. (Corne v3 using nice!nano chips)

Specifically, this device: https://typeractive.xyz/pages/build#corne

Supported:
- [RMK](https://rmk.rs/) firmware
- Split Bluetooth Low Energy (BLE) keyboard
- Default Typeractive Corne [layout](https://docs.typeractive.xyz/build-guides/corne-wireless/firmware#default-keymap)
...
[RMK](https://rmk.rs/) is a feature-rich and easy-to-use keyboard firmware. 
...
3. Flash
   ...
   Note: the build process also produces a .hex file. For the purposes of the typeractive corne keyboard, that's not needed. Ignore it.
